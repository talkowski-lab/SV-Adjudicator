...
if [ "$chrom" = "X" ]; then
    ...
    python scripts/pe_merge_allosomes.py $batch $source X $inputfolder $outputfolder
elif [ "$chrom" = "Y" ]; then
    ...
    python scripts/pe_merge_allosomes.py $batch $source Y $inputfolder $outputfolder
else
